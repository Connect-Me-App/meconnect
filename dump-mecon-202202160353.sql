...
CREATE TABLE `user_post` (
  ...
  `post_imageurl` varchar(255) DEFAULT NULL,
  `post_text` varchar(255) DEFAULT NULL,
  `post_videourl` varchar(255) DEFAULT NULL,
...
--
-- Dumping routines for database 'mecon'
--
...
-- Dump completed on 2022-02-16  3:53:30
